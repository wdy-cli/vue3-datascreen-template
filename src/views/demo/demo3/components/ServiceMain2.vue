<template>
  <section class="service_main_wrap">
    <div class="pic_box">
      <jia-xing-picture-box1 />
      <jia-xing-picture-box2 />
    </div>
  </section>
...
// 引入组件
import jiaXingPictureBox1 from './picturebox2/jiaxing/jiaXingPictureBox1.vue'
import jiaXingPictureBox2 from './picturebox2/jiaxing/jiaXingPictureBox2.vue'
import AreaDetail from './service-tools2/AreaDetail.vue'
// mock
 ...
 */
// 选择城市
const setImgUrlByCity = () => {
  mittBus.emit('getBunkList', bunkData.content)
}
